  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardTitle className="mt-2 text-xl">VerifiedDecision events</CardTitle>
        <CardDescription>
            ...
            {isLoading ? (
              ...
              rows.map((row) => (
                <tr key={row.id} className="border-b last:border-0">
                  ...
                  <td className="px-3 py-4">{row.publicInputsLabel}</td>
                  ...
                  <td className="px-3 py-4">
                    {row.transactionHash !== "0x" ? (
                      ...
                      <span className="text-muted-foreground">Simulation only</span>
                    )}
                  </td>
                </tr>
              ))
